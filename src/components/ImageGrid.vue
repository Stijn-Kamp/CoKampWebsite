<template>
  <div class="lightbox mt-5 p-3">
    <div class="row">
      <div class="col-lg-6">
        <img
          src="@assets/images/examples/example1.jpg"
          data-mdb-img="@assets/images/examples/example1.jpg"
          alt="Table Full of Spices"
          class="w-100 mb-2 mb-md-4 shadow-1-strong rounded"
        />
        <img
          src="@assets/images/examples/example2.jpg"
          data-mdb-img="@assets/images/examples/example2.jpg"
          alt="Table Full of Spices"
          class="w-100 mb-2 mb-md-4 shadow-1-strong rounded"
        />
        <img
        ...
        />
        <img
          src="@assets/images/examples/example6.jpg"
          data-mdb-img="@assets/images/examples/example6.jpg"
          alt="Table Full of Spices"
          class="w-100 mb-2 mb-md-4 shadow-1-strong rounded"
        />
        <img
          src="@assets/images/examples/example7.jpg"
          data-mdb-img="@assets/images/examples/example7.jpg"
          alt="Table Full of Spices"
          class="w-100 mb-2 mb-md-4 shadow-1-strong rounded"
        />
        <img
          src="@assets/images/examples/example8.jpg"
          data-mdb-img="@assets/images/examples/example8.jpg"
          alt="Table Full of Spices"
          class="w-100 mb-2 mb-md-4 shadow-1-strong rounded"
        />
    </div>
